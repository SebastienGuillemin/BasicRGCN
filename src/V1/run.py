...
import torch
from dataloader import Dataloader, prefix
...
if __name__ == '__main__':
    ...
    graph = graph_builder.construct_graph()
    graph.to(device)
    print(graph)
    ...
    with torch.no_grad():
        pred = model(graph)
        # print(pred)
        relation_index, index_1, index_2 = graph_builder.get_relation_entities_index('estProcheDe', prefix + 'echantillon_9477', prefix + 'echantillon_10423')
